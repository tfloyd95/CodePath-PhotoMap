...
class LocationsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate{
    ...
    let CLIENT_ID = "WHZCUPB31PHZVC3JOCADY1CSWFRCEVOEYHGUGKWZVX5NTWNR"
    let CLIENT_SECRET = "QVQRWHSABQH3WTEGUYBNSYPEQWBVFWEQ2AU2IELFSYIKFFHT"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate.locationsPicked(controller: self, latitude: lat, longitude: lng)
